...
"""
import os, sys, sqlite3, subprocess, uuid, hashlib
...
def main():
    ...
    conn.execute('''INSERT INTO jobs (id, fingerprint, source, title, company, url, raw_jd_text, stage, created_at, updated_at)
    ...
    print(f"Launching prep_application.py ...")
